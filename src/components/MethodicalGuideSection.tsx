...
const MethodicalGuideSection = () => {
  ...
  const lessonPlans = [
    ...
    {
      title: "Урок 7: Установление причинно-следственных связей",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 8: Задачи на установление соответствия",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 9: Задачи на правду и ложь",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 10: Задачи на взвешивание",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 11: Задачи на переливание",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 12: Комбинаторные задачи",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 13: Математические понятия и определения",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 14: Доказательства в математике",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 15: Решение текстовых задач",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 16: Геометрические задачи",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 17: Принятие решений",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 18: Критическое мышление",
      duration: "45 минут",
    ...
    {
      title: "Урок 19: Развитие аргументации",
      duration: "45 минут",
    ...
    {
      title: "Урок 20: Решение сложных логических задач",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: 'Урок 21: Игра "Математический бой"',
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 22: Решение текстовых задач (углубленный уровень)",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 23: Геометрические задачи (углубленный уровень)",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 25: Принятие решений (углубленный уровень)",
      duration: "45 минут",
      objectives: [
    ...
    {
      title: "Урок 26: Критическое мышление (углубленный уровень)",
      duration: "45 минут",
    ...
    {
      title: 'Урок 27: Игра "Дебаты" (упрощенная версия)',
      duration: "45 минут",
      objectives: [
        "Развитие критического мышления",
    ...
    {
      title: "Урок 28: Развитие аргументации (углубленный уровень)",
      duration: "45 минут",
      objectives: ["Научиться убеждать и отстаивать свою точку зрения"],
      activities: [
        "Анализ примеров аргументированных выступлений (15 минут)",
    ...
    {
      title: "Урок 29: Решение сложных логических задач (итоговый)",
      duration: "45 минут",
      objectives: [
        "Применить все полученные знания и навыки для решения сложных логических задач",
      ],
    ...
    {
      title: 'Урок 30: Игра "Что? Где? Когда?" (Математическая версия)',
      duration: "45 минут",
      objectives: [
