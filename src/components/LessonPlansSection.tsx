...
const LessonPlansSection = () => {
  const lessonPlans = [
    ...
    {
      title:
        "Урок 4: Сравнение, сложение и вычитание дробей с разными знаменателями",
      duration: "45 минут",
      topic: "Обыкновенные дроби",
      objectives: [
    ...
    {
      title:
        "Урок 7: Арифметические действия с обыкновенными и десятичными дробями",
      duration: "45 минут",
      topic: "Дроби",
      objectives: [
    ...
    {
      title:
        "Урок 13: Объём прямоугольного параллелепипеда, куба, формулы объёма",
      duration: "45 минут",
      topic: "Геометрия",
      objectives: [
    ...
    {
      title: "Урок 14: Осевая и центральная симметрия",
      duration: "45 минут",
      topic: "Геометрия",
      objectives: [
    ...
    {
      title: "Урок 15: Основное свойство дробей",
      duration: "45 минут",
      topic: "Обыкновенные дроби",
      objectives: [
    ...
    {
      title: "Урок 16: Положительные и отрицательные числа",
      duration: "45 минут",
      topic: "Рациональные числа",
      objectives: [
    ...
    {
      title:
        "Урок 17: Прямоугольный параллелепипед, куб, призма, пирамида, конус, цилиндр, шар и сфера",
      duration: "45 минут",
      topic: "Геометрия",
      objectives: [
    ...
    {
      title: "Урок 18: Сравнение и упорядочивание дробей",
      duration: "45 минут",
      topic: "Обыкновенные дроби",
      objectives: [
        "Научить сравнивать дроби с разными знаменателями",
    ...
    {
      title: "Урок 19: Сравнение положительных и отрицательных чисел",
      duration: "45 минут",
      topic: "Рациональные числа",
      objectives: [
