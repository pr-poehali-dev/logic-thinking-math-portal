      ...
      puzzles: [
        {
          ...
          description: "Заполните квадрат числами 1-9 так, чтобы суммы в строках, столбцах и диагоналях были равны 15",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Найдите число от 1 до 9, которое получится, если складывать цифры числа 9876543210 до тех пор, пока не останется одна цифра",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "На часах 3:00. Через сколько часов стрелки снова совпадут?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "Найдите наименьшее число, которое при делении на 2, 3, 4, 5, 6 дает остаток 1",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Какое наименьшее число нужно прибавить к 2023, чтобы получить полный квадрат?",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Представьте число 100 как сумму последовательных натуральных чисел максимально длинной последовательностью",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "Найдите сумму всех двузначных чисел, которые при делении на 7 дают остаток 3",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "Сколько четырехзначных чисел-палиндромов можно составить из цифр 1, 2, 3, 4?",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Найдите седьмой член геометрической прогрессии: 2, 6, 18, ...",
          difficulty: "Легкая",
        ...
        },
        {
          id: "prime-puzzle",
          title: "Простые числа",
          description: "Найдите наибольшее простое число меньше 100, которое остается простым при перестановке цифр",
          difficulty: "Сложная",
      ...
      puzzles: [
        {
          ...
          description: "Человек, волк, коза и капуста должны переправиться через реку. Лодка вмещает только человека и еще одного 'пассажира'",
          difficulty: "Средняя",
          hint: "Человек должен сначала перевезти козу",
          solution: "1) Человек и коза → 2) Человек ← 3) Человек и волк → 4) Человек и коза ← 5) Человек и капуста → 6) Человек ← 7) Человек и коза →"
        },
        {
          id: "truth-lies-village",
          title: "Деревня правдолюбцев и лжецов",
          description: "В деревне живут только правдолюбцы (всегда говорят правду) и лжецы (всегда лгут). Встретив жителя, вы спросили: 'Ты лжец?' Что он ответит?",
          difficulty: "Легкая",
          hint: "Подумайте, что ответит каждый тип жителя",
          solution: "Никто не ответит 'Да'. Правдолюбец скажет правду ('Нет'), лжец солжет ('Нет')"
        },
        {
          id: "prisoners-hats",
          title: "Заключенные и шляпы",
          description: "3 заключенных стоят в ряд. У каждого черная или белая шляпа. Каждый видит шляпы впереди стоящих. Как первый может определить цвет своей шляпы?",
          difficulty: "Сложная",
          hint: "Используйте молчание других как информацию",
          solution: "Если второй молчит, значит он видит одинаковые шляпы. Тогда у первого противоположный цвет"
        },
        {
          id: "light-switches",
          title: "Выключатели и лампочки",
          description: "3 выключателя на первом этаже управляют 3 лампочками на втором. Как за одно посещение второго этажа определить, какой выключатель какой лампочкой управляет?",
          difficulty: "Средняя",
          hint: "Используйте тепло лампочек",
          solution: "Включите первый на долго, второй на чуть-чуть и выключите, третий оставьте выключенным. Горящая - первый, теплая - второй, холодная - третий"
        },
        {
          id: "weighing-balls",
          title: "Взвешивание шаров",
          description: "Среди 12 одинаковых шаров один имеет другой вес. За 3 взвешивания на чашечных весах определите этот шар",
          difficulty: "Сложная",
          hint: "Разделите шары на 3 группы по 4",
          solution: "Сложная стратегия с деревом решений в зависимости от результатов взвешиваний"
        },
        {
          id: "monty-hall",
          title: "Парадокс Монти Холла",
          description: "3 двери: за одной приз, за двумя пусто. Вы выбрали дверь. Ведущий открыл одну из невыбранных пустых дверей. Стоит ли менять выбор?",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Сколько человек нужно собрать, чтобы вероятность совпадения дней рождения у двоих была больше 50%?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "5 пиратов делят 100 монет. Предложение принимается, если за него голосует больше половины. Как должен поделить старший пират?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "На острове 100 людей: некоторые с голубыми, некоторые с карими глазами. Все знают, что голубоглазые должны покинуть остров, но никто не знает цвет своих глаз",
          difficulty: "Сложная",
          hint: "Что произойдет, если приедет логик и скажет: 'Я вижу голубые глаза'?",
          solution: "Если N голубоглазых, они уйдут на N-й день после объявления"
        },
        {
          id: "horses-race",
          title: "Гонки лошадей",
          description: "25 лошадей, 5 дорожек. Нужно найти 3 самых быстрых. Сколько минимум гонок потребуется?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "5 домов разного цвета. В каждом живет человек разной национальности, пьющий разные напитки. Немец пьет кофе. Кто пьет воду?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "На вечеринке каждый пожал руку некоторым гостям. Докажите, что количество людей, пожавших нечетное число рук, четно",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "Два стража: один всегда лжет, другой всегда говорит правду. Две двери: одна ведет к сокровищу. Какой вопрос задать?",
          difficulty: "Средняя",
          hint: "Спросите одного про ответ другого",
          solution: "'Скажет ли другой страж, что левая дверь ведет к сокровищу?' Идите к двери, противоположной ответу"
        },
        {
          id: "muddy-children",
          title: "Грязные дети",
          description: "3 ребенка играли в грязи. У каждого может быть грязное лицо. Каждый видит других, но не себя. Как они узнают, грязные ли они?",
          difficulty: "Сложная",
          hint: "Если бы у меня было чистое лицо, что бы подумали другие?",
          solution: "Анализ по индукции: если все грязные, поймут это на 3-й итерации"
        },
        {
          id: "three-gods",
          title: "Три бога",
          description: "Три бога: Правды, Лжи и Случайности. Нужно определить, кто есть кто, задав 3 вопроса с ответами 'да'/'нет'",
          difficulty: "Сложная",
    ...
    },
    {
      ...
      puzzles: [
        ...
        },
        {
          ...
          solution: "Практически не более 7-8 раз из-за экспоненциального роста толщины"
        },
        {
          id: "circle-sectors",
          title: "Секторы круга",
          description: "Круг разделен на 6 равных секторов. Закрашены 2 несмежных сектора. Какая часть круга закрашена?",
          difficulty: "Легкая",
          hint: "2 из 6 частей",
        ...
        },
        {
          ...
          description: "Найдите все прямоугольные треугольники с целыми сторонами и периметром 60",
          difficulty: "Сложная",
          hint: "a² + b² = c², a + b + c = 60",
        ...
        },
        {
          ...
          description: "Сколько диагоналей можно провести в правильном пятиугольнике?",
          difficulty: "Легкая",
        ...
        },
        {
          ...
          description: "Сколько способов раскрасить грани куба в 3 цвета так, чтобы каждый цвет использовался дважды?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "Можно ли замостить прямоугольник 6×6 прямоугольниками 1×4?",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "В треугольнике со сторонами 5, 5, 8 найдите длину медианы к основанию",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "Правильный шестиугольник разделен на треугольники всеми диагоналями из одной вершины. Сколько треугольников?",
          difficulty: "Легкая",
        ...
        },
        {
          ...
          description: "Сколько одинаковых монет поместится вокруг одной центральной монеты?",
          difficulty: "Средняя",
        ...
        },
        {
          ...
          description: "На доске 8×8 сколько различных квадратов можно нарисовать (включая повернутые)?",
          difficulty: "Сложная",
        ...
        },
        {
          ...
          description: "В квадрат со стороной 4 вписан другой квадрат так, что его вершины лежат на сторонах первого. Найдите минимальную площадь",
          difficulty: "Сложная",
          ...
          <CardContent className="space-y-6">
            ...
            {showSolutions[puzzle.id] && (
              <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded">
                <p className="text-green-800 text-sm font-medium mb-2">Решение:</p>
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center text-sm text-gray-600">
                      <Icon name="Lightbulb" size={16} className="mr-2" />
                      <span className="text-xs">{puzzle.hint}</span>
                    </div>
                    <Button
